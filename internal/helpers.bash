...
known_params=("force-integrated" "clear-locks" "skip-compilation" "non-interactive" "no-sound" "kill-container")
known_params_short=("fi" "cl" "sc" "ni" "ns" "kc")
...
exec_lock_prefix=".rosez-exec-"
exec_lock_suffix=".lock"
read_lock_prefix=".rosez-"
read_lock_suffix=".lock"
...
function signal_handler() {
  echo -e "${colour_red}Execution was aborted, deleting my lock files ($read_lock_file and $exec_lock_file)$colour_end"
  rm -f $lockation/$read_lock_file
